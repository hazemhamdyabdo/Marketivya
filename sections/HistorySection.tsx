      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h3 className="text-slate-500 text-sm font-black uppercase tracking-widest">
              Our Legacy
            </h3>
          </div>
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-white mb-8">
            Founded in Egypt, <br />{" "}
            <span className="text-primary italic">Scaled to UAE.</span>
          </h2>
          <p className="text-slate-400 text-xl leading-relaxed mb-8">
            Marketivya was originally founded in Egypt in 2015. In 2020, we
            expanded to the United Arab Emirates and became officially
            registered under UAE law.
          </p>
