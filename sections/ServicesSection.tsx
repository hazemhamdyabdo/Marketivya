    ...
    <section className="py-24 px-6 md:px-20 bg-background-dark">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h3 className="text-primary font-black uppercase tracking-[0.4em] text-xs mb-4">
            Our Services
          </h3>
          <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white">
            Mastering the <span className="italic">Digital Ecosystem.</span>
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-children">
          {services.map((s, i) => (
            <div
              key={i}
              className="glass-card p-10 rounded-3xl flex flex-col gap-6 hover:bg-white/[0.05] hover:-translate-y-2 transition-all cursor-default"
            >
